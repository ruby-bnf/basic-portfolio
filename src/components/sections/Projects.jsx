...
//         Interactive Book - in collaboration with designers{" "}
//       </h3>
//       <p className="text-gray-400 mb-4">
//         I led the development of an Arduino-based system and software for an
//         audiovisual interactive book.
//       </p>
...
//       <div className="flex justify-center items-center mt-4">
//         {" "}
//         <a className="hover:text-pink-700 border py-1 px-4 rounded font-medium transition-all duration-200 text-gray-400 hover:border hover:border-pink-700 transition-colors cursor-pointer">
//           View project
//         </a>
//       </div>
//     </div>
